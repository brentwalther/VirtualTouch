...
import io.walther.virtualtouch.SearchResultFragment.OnListFragmentInteractionListener;
...
public class MySearchResultRecyclerViewAdapter extends RecyclerView.Adapter<MySearchResultRecyclerViewAdapter.ViewHolder> {
    ...
    public MySearchResultRecyclerViewAdapter(List<SearchResult> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
